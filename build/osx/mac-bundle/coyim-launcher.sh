...
export DYLD_LIBRARY_PATH="$bundle_contents"/F
...
# This is the translation domain
APP=coy
#I18NDIR="$bundle_data/locale" # the locale files should go here
I18NDIR="$bundle_contents/MacOS/i18n" # the locale files should go here
...
$EXEC "$bundle_contents/MacOS/$name-bin" "$@" $EXTRA_ARGS $COY_DEBUG_EXTRA $COYIM_ARGUMENTS
