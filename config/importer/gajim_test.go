...
func (s *GajimSuite) Test_GajimImporter_canDoAFullImport(c *C) {
	...
	c.Assert(*res.Accounts[1], DeepEquals, config.Account{
		...
		KnownFingerprints: []config.KnownFingerprint{
			...
			config.KnownFingerprint{UserID: "bla@rose.com", Fingerprint: decode("7c6c74ddb307c95fa30c3ecab25ee64a54124447")},
			...
			config.KnownFingerprint{UserID: "someone@where.com", Fingerprint: decode("a334e9d582da18f15028f7f7412bc8d15d0a1558"), Untrusted: true},
		},
		RequireTor:          false,
		OTRAutoTearDown:     true,
