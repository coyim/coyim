...
func init() {
	add(`CaptureInitialMasterPassword`, &defCaptureInitialMasterPassword{})
}
...
func (*defCaptureInitialMasterPassword) String() string {
  ...
  <object class="GtkDialog" id="CaptureInitialMasterPassword">
    ...
    <property name="title" translatable="yes">Configure your master password</property>
      ...
      <object class="GtkBox" id="Vbox">
        ...
        <child>
          <object class="GtkLabel" id="passMessage" >
            <property name="label" translatable="yes">Please enter the master password for the configuration file twice.</property>
