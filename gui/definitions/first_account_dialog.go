      ...
      <object class="GtkBox" id="Vbox">
        ...
        <child>
          <object class="GtkLabel" id="message">
            <property name="label" translatable="yes">Since you do not have a configured account, we need to set up one.

You can choose to import an existing one, create a new one or manually configure an existing one.
          ...
          <object class="GtkButtonBox" id="button_box">
            ...
            <child>
              <object class="GtkButton" id="button_existing">
                <property name="label" translatable="yes">Add existing account</property>
