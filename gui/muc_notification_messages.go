...
func getAffiliationUpdateFailureMessage(nickname string, newAffiliation data.Affiliation, err error) *updateFailureMessages {
	...
	return &updateFailureMessages{
		...
		errorDialogHeader:   i18n.Localf("The position of {{ nickname \"%s\" }} couldn't be changed", nickname),
...
func getBannedFailureMessage(nickname string, newAffiliation data.Affiliation, err error) *updateFailureMessages {
	return &updateFailureMessages{
		notificationMessage: i18n.Localf("{{ nickname \"%s\" }} couldn't be {{ affiliation \"banned\" }}.", nickname),
		errorDialogTitle:    i18n.Local("Banning failed"),
		errorDialogHeader:   i18n.Localf("{{ nickname \"%s\" }} couldn't be {{ affiliation \"banned\" }}", nickname),
		errorDialogMessage:  getAffiliationFailureErrorMessage(nickname, newAffiliation, err),
	}
}
...
func getAffiliationFailureErrorMessage(nickname string, newAffiliation data.Affiliation, err error) string {
	if err == session.ErrOwnerAffiliationRevokeConflict {
		return i18n.Local("You can't change your own position because you are the only {{ affiliation \"owner\" }} for this room. Every room must have at least one {{ affiliation \"owner\" }}.")
	}
...
func getUpdateAffiliationFailureErrorMessage(nickname string, newAffiliation data.Affiliation) string {
	...
	case newAffiliation.IsOwner():
		return i18n.Localf("An error occurred trying to change the position of {{ nickname \"%s\" }} to {{ affiliation \"owner\" }}.", nickname)
	case newAffiliation.IsAdmin():
		return i18n.Localf("An error occurred trying to change the position of {{ nickname \"%s\" }} to {{ affiliation \"administrator\" }}.", nickname)
	case newAffiliation.IsMember():
		return i18n.Localf("An error occurred trying to change the position of {{ nickname \"%s\" }} to {{ affiliation \"member\" }}.", nickname)
	case newAffiliation.IsBanned():
		return i18n.Localf("An error occurred trying to ban {{ nickname \"%s\" }}.", nickname)
	}
	return i18n.Localf("An error occurred trying to change the position of {{ nickname \"%s\" }}.", nickname)
}
...
func getRoleUpdateFailureMessage(nickname string, newRole data.Role) *updateFailureMessages {
	...
	return &updateFailureMessages{
		...
		errorDialogHeader:   i18n.Localf("The role of {{ nickname \"%s\" }} couldn't be changed", nickname),
...
func getUpdateRoleFailureErrorMessage(nickname string, newRole data.Role) string {
	switch {
	case newRole.IsModerator():
		return i18n.Localf("An error occurred trying to change the role of {{ nickname \"%s\" }} to {{ role \"moderator\" }}.", nickname)
	case newRole.IsParticipant():
		return i18n.Localf("An error occurred trying to change the role of {{ nickname \"%s\" }} to {{ role \"participant\" }}.", nickname)
	case newRole.IsVisitor():
		return i18n.Localf("An error occurred trying to change the role of {{ nickname \"%s\" }} to {{ role \"visitor\" }}.", nickname)
	}
	return i18n.Localf("An error occurred trying to change the role of {{ nickname \"%s\" }}.", nickname)
}
...
func getRoleRemoveFailureMessage(nickname string, actorAffiliation data.Affiliation, err error) *updateFailureMessages {
	return &updateFailureMessages{
		...
		errorDialogHeader:   i18n.Localf("{{ nickname \"%s\" }} couldn't be expelled", nickname),
...
func getRoleRemoveFailureMessageBasedOnError(nickname string, actorAffiliation data.Affiliation, err error) string {
	...
	return i18n.Localf("An error occurred expelling {{ nickname \"%s\" }}.", nickname)
}
...
func getRoleRemoveFailureMessageWithActor(nickname string, actorAffiliation data.Affiliation) string {
	if actorAffiliation != nil {
		...
		case actorAffiliation.IsOwner():
			return i18n.Localf("As {{ affiliation \"an owner\" }} you don't have permissions to expel {{ nickname \"%s\" }}.", nickname)
		case actorAffiliation.IsAdmin():
			return i18n.Localf("As {{ affiliation \"an administrator\" }} you don't have permissions to expel {{ nickname \"%s\" }}.", nickname)
		case actorAffiliation.IsMember():
			return i18n.Localf("As {{ affiliation \"a member\" }} you don't have permissions to expel {{ nickname \"%s\" }}.", nickname)
		}
	}

	return i18n.Localf("You don't have permissions to expel {{ nickname \"%s\" }}.", nickname)
}
...
func getAffiliationRemovedMessageWithOwnerActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.Previous.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an owner\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an administrator\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"a member\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s.",
		affiliationUpdate.Actor.Nickname,
		affiliationUpdate.Nickname)
}
...
func getAffiliationRemovedMessageWithAdminActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.Previous.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an owner\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an administrator\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"a member\" }} anymore.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s.",
		affiliationUpdate.Actor.Nickname,
		affiliationUpdate.Nickname)
}
...
func getAffiliationBannedMessageWithoutActor(affiliationUpdate data.AffiliationUpdate) string {
	return i18n.Localf("{{ nickname \"%s\" }} was {{ affiliation \"banned\" }} from the room.", affiliationUpdate.Nickname)
}
...
func getAffiliationBannedMessageWithActor(affiliationUpdate data.AffiliationUpdate) string {
	...
	case affiliationUpdate.Actor.Affiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s {{ affiliation \"banned\" }} %[2]s from the room.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Actor.Affiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s {{ affiliation \"banned\" }} %[2]s from the room.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("%[1]s {{ affiliation \"banned\" }} %[2]s from the room.", affiliationUpdate.Actor.Nickname, affiliationUpdate.Nickname)
}
...
func getAffiliationAddedMessageWithOwnerActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"an owner\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"an administrator\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"a member\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"banned\" }}",
		affiliationUpdate.Actor.Nickname,
		affiliationUpdate.Nickname)
}
...
func getAffiliationAddedMessageWithAdminActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"an owner\" }}",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"an administrator\" }}",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"a member\" }}",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is now {{ affiliation \"banned\" }}",
		affiliationUpdate.Actor.Nickname,
		affiliationUpdate.Nickname)
}
...
func getAffiliationChangedMessageWithOwnerActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.Previous.IsOwner() && affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"administrator\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsOwner() && affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"member\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin() && affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"owner\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin() && affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"member\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember() && affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"owner\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember() && affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"administrator\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s.",
...
func getAffiliationChangedMessageWithAdminActor(affiliationUpdate data.AffiliationUpdate) string {
	switch {
	case affiliationUpdate.Previous.IsOwner() && affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"administrator\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsOwner() && affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"member\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin() && affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"owner\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsAdmin() && affiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"member\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember() && affiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"owner\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	case affiliationUpdate.Previous.IsMember() && affiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"administrator\" }}.",
			affiliationUpdate.Actor.Nickname,
			affiliationUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s.",
...
func getRoleRemovedMessageWithActor(roleUpdate data.RoleUpdate) string {
	...
	case roleUpdate.Actor.Affiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s temporarily removed %[2]s from the room.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Actor.Affiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s temporarily removed %[2]s from the room.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	}
...
func getRoleChangedMessageWithoutActor(roleUpdate data.RoleUpdate) string {
	...
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsModerator():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsModerator():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The role of {{ nickname \"%s\" }} was changed from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			roleUpdate.Nickname)
	}
	return i18n.Localf("The role of {{ nickname \"%s\" }} was changed.",
		roleUpdate.Nickname)
}
...
func getRoleChangedMessageWithOwnerActor(roleUpdate data.RoleUpdate) string {
	switch {
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the role of %[2]s.",
		roleUpdate.Actor.Nickname,
		roleUpdate.Nickname)
}
...
func getRoleChangedMessageWithAdminActor(roleUpdate data.RoleUpdate) string {
	switch {
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the role of %[2]s.",
		roleUpdate.Actor.Nickname,
		roleUpdate.Nickname)
}
...
func getRoleChangedMessageForActor(roleUpdate data.RoleUpdate) string {
	switch {
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsParticipant():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsModerator() && roleUpdate.New.IsVisitor():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsModerator():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsParticipant() && roleUpdate.New.IsVisitor():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsModerator():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	case roleUpdate.Previous.IsVisitor() && roleUpdate.New.IsParticipant():
		return i18n.Localf("%[1]s changed the role of %[2]s from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			roleUpdate.Actor.Nickname,
			roleUpdate.Nickname)
	}
...
func getSelfRoleUpdateMessageForOwnerActor(selfRoleUpdate data.RoleUpdate) string {
	switch {
	case selfRoleUpdate.Previous.IsParticipant() && selfRoleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsParticipant() && selfRoleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsVisitor() && selfRoleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsVisitor() && selfRoleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsModerator() && selfRoleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsModerator() && selfRoleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.New.IsNone():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} has temporarily expelled you from the room.",
			selfRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your role.",
		selfRoleUpdate.Actor.Nickname)
}
...
func getSelfRoleUpdateMessageForAdminActor(selfRoleUpdate data.RoleUpdate) string {
	switch {
	case selfRoleUpdate.Previous.IsParticipant() && selfRoleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"participant\" }} to {{ role \"visitor\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsParticipant() && selfRoleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"participant\" }} to {{ role \"moderator\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsVisitor() && selfRoleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"visitor\" }} to {{ role \"participant\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsVisitor() && selfRoleUpdate.New.IsModerator():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"visitor\" }} to {{ role \"moderator\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsModerator() && selfRoleUpdate.New.IsVisitor():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"moderator\" }} to {{ role \"visitor\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.Previous.IsModerator() && selfRoleUpdate.New.IsParticipant():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.New.IsNone():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} has temporarily expelled you from the room.",
			selfRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your role.",
		selfRoleUpdate.Actor.Nickname)
}
...
func getSelfRoleUpdateMessageForActor(selfRoleUpdate data.RoleUpdate) string {
	...
	case selfRoleUpdate.Previous.IsModerator() && selfRoleUpdate.New.IsParticipant():
		return i18n.Localf("{{ nickname \"%s\" }} changed your role from {{ role \"moderator\" }} to {{ role \"participant\" }}.",
			selfRoleUpdate.Actor.Nickname)
	case selfRoleUpdate.New.IsNone():
		return i18n.Localf("{{ nickname \"%s\" }} has temporarily expelled you from the room.",
			selfRoleUpdate.Actor.Nickname)
	}
...
func getAffiliationRoleUpateForAffiliationRemovedWithoutActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	...
	return i18n.Localf("{{ nickname \"%s\" }} is not {{ affiliation \"banned\" }} anymore.",
		affiliationRoleUpdate.Nickname)
}
...
func getAffiliationRoleUpateForAffiliationRemovedWithOwnerActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	...
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"banned\" }} anymore.",
		affiliationRoleUpdate.Actor.Nickname,
		affiliationRoleUpdate.Nickname)
}
...
func getAffiliationRoleUpateForAffiliationRemovedWithAdminActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	...
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"banned\" }} anymore.",
		affiliationRoleUpdate.Actor.Nickname,
		affiliationRoleUpdate.Nickname)
}
...
func getAffiliationRoleUpateForAffiliationRemovedForActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case affiliationRoleUpdate.PreviousAffiliation.IsOwner():
		return i18n.Localf("%[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an owner\" }} anymore.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsAdmin():
		return i18n.Localf("%[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"an administrator\" }} anymore.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsMember():
		return i18n.Localf("%[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"a member\" }} anymore.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	}
	return i18n.Localf("%[1]s changed the position of %[2]s; %[2]s is not {{ affiliation \"banned\" }} anymore.",
		affiliationRoleUpdate.Actor.Nickname,
		affiliationRoleUpdate.Nickname)
}
...
func getAffiliationRoleUpdateForAffiliationAddedWithOwnerActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case affiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s to {{ affiliation \"owner\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s to {{ affiliation \"administrator\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s to {{ affiliation \"member\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} %[1]s changed the position of %[2]s.",
...
func getAffiliationRoleUpdateForAffiliationAddedWithAdminActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case affiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s to {{ affiliation \"owner\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s to {{ affiliation \"administrator\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s to {{ affiliation \"member\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} %[1]s changed the position of %[2]s.",
...
func getAffiliationRoleUpdateForAffiliationAddedForActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case affiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("%[1]s changed the position of %[2]s to {{ affiliation \"owner\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("%[1]s changed the position of %[2]s to {{ affiliation \"administrator\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("%[1]s changed the position of %[2]s to {{ affiliation \"member\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	}
...
func getAffiliationRoleUpdateForAffiliationUpdatedForActor(affiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case affiliationRoleUpdate.PreviousAffiliation.IsMember() && affiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"administrator\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsMember() && affiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"member\" }} to {{ affiliation \"owner\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsAdmin() && affiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"member\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsAdmin() && affiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"administrator\" }} to {{ affiliation \"owner\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsOwner() && affiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"member\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	case affiliationRoleUpdate.PreviousAffiliation.IsOwner() && affiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("%[1]s changed the position of %[2]s from {{ affiliation \"owner\" }} to {{ affiliation \"administrator\" }}.",
			affiliationRoleUpdate.Actor.Nickname,
			affiliationRoleUpdate.Nickname)
	}
	return i18n.Localf("%[1]s changed the position of %[2]s.",
...
func getSelfAffiliationRoleUpateForAffiliationRemovedWithActor(selfAffiliationRoleUpdate data.AffiliationRoleUpdate) string {
	...
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"an owner\" }} anymore.",
	...
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"an administrator\" }} anymore.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.PreviousAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"a member\" }} anymore.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsAdmin() && selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"an owner\" }} anymore.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsAdmin() && selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"an administrator\" }} anymore.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsAdmin() && selfAffiliationRoleUpdate.PreviousAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"a member\" }} anymore.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position.",
		selfAffiliationRoleUpdate.Actor.Nickname)
}
...
func getSelfAffiliationRoleUpdateForAffiliationAddedWithActor(selfAffiliationRoleUpdate data.AffiliationRoleUpdate) string {
	...
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"member\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.Actor.Affiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position to {{ affiliation \"member\" }}.",
		selfAffiliationRoleUpdate.Actor.Nickname)
}
...
func getSelfAffiliationRoleUpdateForAffiliationUpdatedWithOwnerActor(selfAffiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"owner\" }} to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"owner\" }} to {{ affiliation \"member\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"administrator\" }} to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"administrator\" }} to {{ affiliation \"member\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsMember() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"member\" }} to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsMember() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"member\" }} to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position.",
		selfAffiliationRoleUpdate.Actor.Nickname)
}
...
func getSelfAffiliationRoleUpdateForAffiliationUpdatedWithAdminActor(selfAffiliationRoleUpdate data.AffiliationRoleUpdate) string {
	switch {
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"owner\" }} to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsOwner() && selfAffiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"owner\" }} to {{ affiliation \"member\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"administrator\" }} to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsAdmin() && selfAffiliationRoleUpdate.NewAffiliation.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"administrator\" }} to {{ affiliation \"member\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsMember() && selfAffiliationRoleUpdate.NewAffiliation.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"member\" }} to {{ affiliation \"owner\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	case selfAffiliationRoleUpdate.PreviousAffiliation.IsMember() && selfAffiliationRoleUpdate.NewAffiliation.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position from {{ affiliation \"member\" }} to {{ affiliation \"administrator\" }}.",
			selfAffiliationRoleUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position.",
		selfAffiliationRoleUpdate.Actor.Nickname)
...
func getSelfAffiliationRemovedMessageWithOwnerActor(selfAffiliationUpdate data.SelfAffiliationUpdate) string {
	...
	return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"banned\" }} anymore.",
		selfAffiliationUpdate.Actor.Nickname)
}
...
func getSelfAffiliationRemovedMessageWithAdminActor(selfAffiliationUpdate data.SelfAffiliationUpdate) string {
	...
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are not {{ affiliation \"banned\" }} anymore.",
		selfAffiliationUpdate.Actor.Nickname)
}
...
func getSelfAffiliationAddedMessageWithOwnerActor(selfAffiliationUpdate data.SelfAffiliationUpdate) string {
	switch {
	case selfAffiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"an owner\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	case selfAffiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"an administrator\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	case selfAffiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"a member\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"banned\" }}.",
		selfAffiliationUpdate.Actor.Nickname)
}
...
func getSelfAffiliationAddedMessageWithAdminActor(selfAffiliationUpdate data.SelfAffiliationUpdate) string {
	switch {
	case selfAffiliationUpdate.New.IsOwner():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"an owner\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	case selfAffiliationUpdate.New.IsAdmin():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"an administrator\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	case selfAffiliationUpdate.New.IsMember():
		return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"a member\" }}.",
			selfAffiliationUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} changed your position; you are now {{ affiliation \"banned\" }}.",
		selfAffiliationUpdate.Actor.Nickname)
}
...
func getSelfAffiliationBannedMessageWithActor(selfAffiliationUpdate data.SelfAffiliationUpdate) string {
	if selfAffiliationUpdate.Actor.Affiliation.IsOwner() {
		return i18n.Localf("The {{ affiliation \"owner\" }} {{ nickname \"%s\" }} {{ affiliation \"banned\" }} you from the room.",
			selfAffiliationUpdate.Actor.Nickname)
	}
	return i18n.Localf("The {{ affiliation \"administrator\" }} {{ nickname \"%s\" }} {{ affiliation \"banned\" }} you from the room.",
		selfAffiliationUpdate.Actor.Nickname)
}
