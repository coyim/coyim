...
func (*MucOccupantRolePrivilegesSuite) Test_Occupant_canKickOccupantBasedOnRole_ofModerator(c *C) {
	o := &Occupant{}
	...
	o.ChangeRoleToModerator()
	c.Assert(o.canKickOccupantBasedOnRole(oc), Equals, false)
...
func (*MucOccupantRolePrivilegesSuite) Test_Occupant_canKickOccupantBasedOnRole_ofParticipant(c *C) {
	o := &Occupant{}
	...
	o.ChangeRoleToModerator()
	c.Assert(o.canKickOccupantBasedOnRole(oc), Equals, true)
...
func (*MucOccupantRolePrivilegesSuite) Test_Occupant_canKickOccupantBasedOnRole_ofVisitor(c *C) {
	o := &Occupant{}
...
func (*MucOccupantRolePrivilegesSuite) Test_Occupant_canKickOccupantBasedOnRole_ofKicked(c *C) {
	o := &Occupant{}
