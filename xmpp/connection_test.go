...
func (s *ConnectionXmppSuite) Test_Dial_worksIfTheHandshakeSucceeds(c *C) {
	...
	c.Assert(err, Equals, io.EOF)
	c.Assert(string(rw.write[0]), Equals, "<?xml version='1.0'?><stream:stream to='www.olabini.se' xmlns='jabber:client' xmlns:stream='http://etherx.jabber.org/streams' version='1.0'>\n")
	c.Assert(string(rw.write[1]), Equals, "<?xml version='1.0'?><stream:stream to='www.olabini")
	c.Assert(string(rw.write[2]), Equals, "\x17\x03\x03\x00\xc0\x00\x01\x02\x03\x04\x05\x06\a\b\t\n"+
		"\v\f\r\x0e\x0f7ѱ\n"+
		"9[\x9d\\!\xcd4\xfa\x18\xd6y\xb0y\xf2\x94T\x96\xb3\x9e\x16\xfdŷ\x9a\xf3Ʒ\xa9n@\xa5\tO\x8cE\x84\x85\x15#\x04\x97\xce\xfc\x12\x93;\xd8\xcdl>Q\xe52\x9f\xc1\x84\xf2cj\x81_U\x86\xcf6\xadڦC\xe6\x13\xfa\xc8%-\x15\xd5E\xe2h\x91\xfc\xa0+\x94\x13\xe3gG\xe6\xff\xe5`'و\x9fM\xea\xc780N\xd5\u9fdc\xf5)\xfdݫ3\xf0\x8ee/`8@")
	c.Assert(string(rw.write[3]), Equals, ""+
		"\x17\x03\x03\x00\xc0\x00\x01\x02\x03\x04\x05\x06\a\b\t\n"+
		"\v\f\r\x0e\x0f7ѱ\n"+
		"9[\x9d\\!\xcd4\xfa\x18\xd6y\xb0y\xf2\x94T\x96\xb3\x9e\x16\xfdŷ\x9a\xf3Ʒ\xa9n@\xa5\tO\x8cE\x84\x85\x15#\x04\x97\xce\xfc\x12\x93;\xd8\xcdl>")
	c.Assert(string(rw.write[4]), Equals, "\x17\x03\x03\x00\xc0\x00")
	c.Assert(string(rw.write[5]), Equals, "\x17\x03\x03\x00\xc0\x00\x01\x02\x03\x04\x05\x06\a\b\t\n"+
		"\v\f\r\x0e\x0f7ѱ\n"+
		"9[\x9d\\!\xcd4\xfa\x18\xd6y\xb0y\xf2\x94T\x96\xb3\x9e\x16\xfdŷ\x9a\xf3Ʒ\xa9n@\xa5\tO\x8cE\x84\x85\x15#\x04\x97\xce\xfc\x12")
	c.Assert(string(rw.write[6]), Equals, "\x17\x03\x03\x00\xc0\x00\x01\x02\x03\x04\x05\x06\a\b\t\n"+
		"\v\f\r\x0e\x0f7ѱ\n"+
